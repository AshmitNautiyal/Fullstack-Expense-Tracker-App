...
import {DateRange} from "../components/data-range.jsx";
import {MdAdd} from "react-icons/md";
import { RiProgress3Line } from "react-icons/ri";
import { TiWarning } from "react-icons/ti";
import { formatCurrency } from '../libs/index.js';
import { ViewTransaction } from '../components/view-transaction.jsx';
import { AddTransaction } from '../components/add-transaction.jsx';
        ...
        <Title title = "Transactions Activity" />
         ...
         <div className ="flex flex-col md:flex-row md:items-center gap-4">
           ...
           {/* <JsonToExcel
            data={data}
            title="Export"
            fileName={`Transactions ${startDate}-${endDate}`}
            btnClassName="flex items-center gap-2 text-black dark:text-gray-300"
           /> */}
          ...
          <>
           <table className = "w-full">
             ...
             {data?.map((item , index)=>(
              <tr
              key = {index}
              className = "w-full border-b border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-500"
              >
               <td className = "py-4">
